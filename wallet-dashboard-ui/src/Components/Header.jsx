  ...
  return (
    <header className="App-header">
      <div className="header_top">
        <div className="header_title">Wallet Dashboard</div>
      ...
      <div className="header_options">
          ...
          {showEdit ? (
            <form onSubmit={handleEdit}>
              <input
                ...
                pattern="^\d+(\.\d+)?$"
                value={inputExRate}
                onChange={(e) => setInputExRate(e.target.value)}
              />
              <AiOutlineCheck
                className="header_options_left_check_icon"
                type="submit"
                onClick={handleEdit}
              />
              <AiOutlineClose
                className="header_options_left_close_icon"
                type="button"
            ...
            <>
              ...
              <AiFillEdit
                className="header_options_left_edit_icon"
                onClick={() => setShowEdit(true)}
              />
              {editedExRate && (
                <AiOutlineReload
                  className="header_options_left_reload_icon"
        ...
        <div className="header_options_right">
          ...
          <div>
            ...
            <input
              type="checkbox"
              onChange={(e) => setPinFavorites(e.target.checked)}
            />
          </div>
        </div>
      </div>
